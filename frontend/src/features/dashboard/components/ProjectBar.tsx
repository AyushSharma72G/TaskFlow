...
import { selectProjects, selectProjectsError, selectProjectsLoading } from "../../projects/store/projectsSelectors";
    ...
    return(
        <div className="w-full px-2 md:px-0 ">
            <div className="flex justify-between w-full mt-10 mb-3 w-full items-center">
                        ...
                        <p onClick={()=>navigate('/projects')} className="cursor-pointer text-[var(--color-primary-light)]">
                            View All
                        </p>
            </div>
      ...
      { loading ? (
         <FallBackUIComponent message="Your Projects Are loading...."/>
             ...
             <PrimaryButton
                ...
                return(
                    ...
                    <p className="font-[var(--font-weight-description)] text-[var(--color-text-secondary)]">
                         <span className="font-[var(--font-weight-subheading)]">Due:</span> {new Date(project.dueDate).toLocaleDateString(undefined, {
                               month: "short",
                               day: "numeric",
                               year: "numeric",
                    })}
                    ...
                    <p className="font-[var(--font-weight-description)]">
                        ...
                        <div className="bg-[var(--color-primary-light)] h-full transition-all duration-500" 
