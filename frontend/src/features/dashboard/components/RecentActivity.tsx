...
import { selectActivityError, selectActivityLoading, selectActivityLogs } from "../../activity/store/activitySelectors";
    ...
    return(
        <div className="flex flex-col w-full">
            ...
            <div className="flex justify-between w-full md:mt-10 mb-3 w-full items-center">
                <p className="font-[var(--font-weight-subheading)]">
                    Recent Activity
                </p>
                <p onClick={()=>naviagte('/activity')} className="cursor-pointer text-[var(--color-primary-light)]">
                  View All
                </p>
            </div>
            ...
            {error ? (
                <div>
                   <p className="text-sm font-medium"
                    ...
                    <p className="mt-0.5 text-xs max-w-xs"
            ...
            {loading ? (
                <FallBackUIComponent message="Your Activities are loading..."/>
                ) :
                logs.length===0 ? (
                 <div className="rounded-[var(--radius-xl)] border border-dashed border-[var(--color-border)] bg-[var(--color-surface)] p-8 shadow-[var(--shadow-sm)] md:p-10">
                         <p className="text-[var(--color-text-secondary)] font-[var(--font-weight-heading)] text-center pb-3">No activities here</p>
                         <p className="max-w-md text-left text-[var(--color-text-secondary)]">
                           You don't have any activities yet. Create one to get started and begin
