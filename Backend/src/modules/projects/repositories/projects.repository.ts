...
export class ProjectsRepository {
  ...
  async findProjectsWhereUserIsMember(userId: string): Promise<
    Omit<ProjectListItem, 'progress'>[]
  > {
  ...
  async createProjectAndAddAdminMember(params: {
    ...
    try {
      ...
      // Best-effort rollback: avoid leaving a project without an admin member row.
